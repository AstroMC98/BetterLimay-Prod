...
|---|---|---|---|---|---|
| GAP-004 | Executive officials | **Resolved 2026-09-25.** Mayor and Vice Mayor published from the 2025 election results (ABS-CBN aggregation of Comelec transmissions, 100% of ERs). The Mayor's legal name, Richie Jason D. David, is from the DTI CMCI Limay profile | Published as current officials, term 2025–2028 | Replace with the Municipality's own roster when one is published | Resolved |
| GAP-005 | Elected officials | **Mostly resolved 2026-09-25.** The 8 Sangguniang Bayan members are published from the same results, with every contest's full vote table. Outstanding: legal names (shown under ballot names) and the two ex-officio members, see GAP-022 and GAP-025 | Ballot names, stated in provenance | Obtain the Sangguniang Bayan's official roster | Partial |
| GAP-006 | Departments/offices | **Partly resolved 2026-09-25.** Municipal Hall contact (DTI CMCI), Limay Water District (its own charter, p. 140), Limay Polytechnic College and the police station (maintainer list, cited) are published. The 12 placeholder department records were removed. Outstanding: individual municipal departments, their heads, hours and locations, see GAP-024 | Only offices with a citable contact are listed | Obtain the Municipality's department directory | Partial |
...
| GAP-008 | Barangays | **Resolved 2026-09-25.** All 12 barangays published with PSGC code, class, 2024 population and all 232 officials (DILG roster, term 2023–2026). Middle names reduced to initials and SK-row phone numbers withheld by design. Barangay coordinates remain open, see GAP-023 | Published | Refresh after the next barangay elections | Resolved |
...
| GAP-022 | Ex-officio officials | ABC Federation President and SK Federation President, who sit on the Sangguniang Bayan | Identify from an official Sangguniang Bayan or DILG publication | Open |
| GAP-023 | Barangay locations | Verified coordinates for the 12 barangay halls; the barangay map stays hidden until at least one exists | Record coordinates from an official source (PSA, NAMRIA or the Municipality) | Open |
| GAP-024 | Municipal departments | Department list, heads, hours, rooms and direct numbers for Limay's own offices (BPLO, Civil Registrar, Treasurer, Assessor, MSWDO, MDRRMO…) | Obtain the Municipality's directory or its Citizen's Charter | Open |
| GAP-025 | Official names | Legal names of the Vice Mayor and Sangguniang Bayan members (published under ballot names) | Replace from the Sangguniang Bayan's roster; the transform's LEGAL_NAMES map takes them | Open |
